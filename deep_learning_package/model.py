...
class Cate(DistilBertPreTrainedModel):
    ...
    def forward(
        ...
        house = self.house_out(self.house_in(pooled_output))
        beauty = self.beauty_out(self.beauty_in(pooled_output))
        baby = self.baby_out(self.baby_in(pooled_output))
        kitchen = self.kitchen_out(self.kitchen_in(pooled_output))
